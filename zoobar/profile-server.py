...
class ProfileAPIServer(rpclib.RpcServer):
    def __init__(self, user, visitor):
        ...
        os.chdir(os.path.join('/tmp', user))
        print 'initing ProfileAPIServer', user, os.path.join('/tmp', user)
        os.setresgid(61012, 61012, 61012)
        os.setresuid(61015, 61015, 61015)
